# Intel Trademarks Logo 1200x1200 | (Holloway) Chew, Kean Ho's Visuals

[![logo](/Pictures/banner_1200x1200.svg)](#)

The Intel Trademarks Logo. They published clear trademark guidelines and
supplied the required material files for it. The preferred version is `.svg`
which has non-destructive scale up & down properties and can be converted into
any rasterized images (e.g. `jpeg`, `webp`, `avif`, etc). To comply with our
standards, a re-draw is required.

This project re-draws Intel Trademarks Logo specifically for 1200x1200 size.
...
Since Intel published its brand and trademark guideline, **from time to time,
you should refer the following resources to avoid any unwanted legal
implications**:
...
* https://www.intel.com/content/www/us/en/trademarks/trademark-list.html

While not specified by Intel, please ensure the outputs are also web ready.
Refer:
...
```
--------------------------------------------------------------------------------
Title: Intel Trademarks Logo 1200x1200
Creators: (Holloway) Chew, Kean Ho
Contact: hello@chewkeanho.com
SKU: chewkeanho-visuals-trademarks-intel-1200x1200
UUID: 25818A65-A68E-412D-B16B-24CABCF6457A
License: Creative Commons Attribution-NoDerivatives 4.0 International License
Made On: 2026-02-09
Made From: Malaysia, South East Asia
Procure: https://github.com/chewkeanho/visuals-trademarks-intel-1200x1200
--------------------------------------------------------------------------------
```
...
> COMPLY WITH INTEL TRADEMARK REQUIREMENTS
> (Read: https://www.intel.com/content/www/us/en/trademarks/trademarks.html)**.
>
